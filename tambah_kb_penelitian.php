...
$query_bk_sks = "SELECT SUM(bk_sks) FROM kb_penelitian_temp  WHERE id_user = '$id_user'";
$result       = mysqli_query( $conn, $query_bk_sks );
$hasil        = $result->fetch_assoc();
$test         = implode( $hasil );

$query_kinerja_sks = "SELECT SUM(kinerja_sks) FROM kb_penelitian_temp WHERE id_user = '$id_user'";
...
$total = $test + $test1;
$db    = new Database();
$q     = "SELECT MAX(id_kbpl) as id_kbpl FROM kb_penelitian";
$db->query( $q );
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                TAMBAH KINERJA BIDANG PENELITIAN
                            </h2>
                        </div>
                        <div class="body">
                            <form action="pages/tambah_kb_penelitian_temp.php" method="POST"
                                  enctype="multipart/form-data">
                                <input type="hidden" name="id_user" value="<?php echo $id_user ?>">
                                <input type="hidden" name="id_kbpl"
                                       value="<?php echo count( $last_no_kbp ) > 0 ? $last_no_kbp[0]->id_kbpl + 1 : 0 + 1 ?>">
                                <div class="row clearfix">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                DATA KINERJA BIDANG PENELITIAN SEMENTARA
                            </h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
									...
									$id_user = $_SESSION['id_user'];
									$db = new Database();
									$query = "SELECT * FROM kb_penelitian_temp WHERE id_user = '$id_user'";
									$db->query( $query );
									$kbp_temp = $db->fetch();
                            ...
                            <form action="pages/simpan_kb_penelitian.php" method="POST">
                                <input type="hidden" name="id_user" value="<?php echo $id_user ?>">
                                <div class="row clearfix">
                                    <br>
                                    <div class="">
                                    ...
                                    <div class="">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <label>Nomor KBPL</label>
                                                    <input readonly type="text" class="form-control" name="nomor_kbpl"
                                    ...
                                    <div class="">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <button type="submit" name="simpan_kb_penelitian_detil"
