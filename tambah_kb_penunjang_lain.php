...
$total = $test + $test1;
$db    = new Database();
$q     = "SELECT MAX(id_kbpn) as id_kbpn FROM kb_penunjang_lain";
$db->query( $q );
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                TAMBAH KINERJA PENUNJANG LAINNYA
                            </h2>
                        </div>
                        <div class="body">
                            <form action="pages/tambah_kb_penunjang_temp.php" method="POST"
                                  enctype="multipart/form-data">
                                <input type="hidden" name="id_user" value="<?php echo $id_user ?>">
                                <input type="hidden" name="id_kbpn"
                                       value="<?php echo count( $last_no_kbp ) > 0 ? $last_no_kbp[0]->id_kbpn + 1 : 0 + 1 ?>">
                                <div class="row clearfix">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                DATA KINERJA BIDANG PENUNJANG LAINNYA SEMENTARA
                            </h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
									...
									$id_user = $_SESSION['id_user'];
									$db = new Database();
									$query   = "SELECT * FROM kb_penunjang_lain_temp WHERE id_user = '$id_user'";
									$db->query( $query );
									$kbp_temp = $db->fetch();
                            ...
                            <form action="pages/simpan_kb_penunjang_lain.php" method="POST">
                                <input type="hidden" name="id_user" value="<?php echo $id_user ?>">
                                <div class="row clearfix">
                                    <br>
                                    <div class="">
                                    ...
                                    <div class="">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <label>Nomor KBPN</label>
                                                    <input readonly type="text" class="form-control" name="nomor_kbpn"
                                                           value="<?php echo count( $last_no_kbp ) > 0 ? $last_no_kbp[0]->id_kbpn + 1 : 0 + 1 ?>">
                                                </div>
                                            </div>
                                        </div>
