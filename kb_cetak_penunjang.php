...
$penunjang     = get_data( "SELECT * FROM kb_penunjang_lain WHERE id_user = '$_SESSION[id_user]' AND tahun_ajaran = (SELECT tahun FROM tahun_ajaran WHERE status = 1)" );
...
<div class="Section1" style="padding-top:200px">
    ...
    <table id="header-table" width="100%">
        ...
        <tr id="heading">
            <td colspan="5">
                <h3>II. BIDANG PENUNJANG LAIN</h3>
            </td>
        </tr>
		<?php foreach ( $penunjang as $p => $pend ): ?>
            <tr id="body">
                <td><?php echo $p + 1 ?></td>
