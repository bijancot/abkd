...
$query_bk_sks = "SELECT SUM(bk_sks) FROM kb_pendidikan_temp WHERE id_user = '$id_user'";
$result       = mysqli_query( $conn, $query_bk_sks );
$hasil        = $result->fetch_assoc();
$test         = implode( $hasil );

$query_kinerja_sks = "SELECT SUM(kinerja_sks) FROM kb_pendidikan_temp WHERE id_user = '$id_user'";
...
$db = new Database();
$q  = "SELECT MAX(id_kbp) as id_kbp FROM kb_pendidikan";
$db->query( $q );
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="pages/tambah_kb_pendidikan_temp.php" method="POST"
                                  enctype="multipart/form-data">
                                <input type="hidden" name="id_user" value="<?php echo $id_user ?>">
                                <input type="hidden" name="id_kbp"
                                       value="<?php echo count( $last_no_kbp ) > 0 ? $last_no_kbp[0]->id_kbp + 1 : 0 + 1 ?>">
                                <div class="row clearfix">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                DATA KINERJA BIDANG PENDIDIKAN SEMENTARA
                            </h2>
                        </div>
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
									...
									$id_user = $_SESSION['id_user'];
									$db = new Database();
									$query   = "SELECT * FROM kb_pendidikan_temp WHERE id_user = '$id_user'";
									$db->query( $query );

									foreach ( $db->fetch() as $key=> $kb_pendidikan ):
										?>
                                        <tr>
                                            <td><?php echo $kb_pendidikan->jenis_kegiatan ?></td>
                                            <td><a href="files/kb_pendidikan/<?php echo $kb_pendidikan->bk_buktipenugasan ?>"
                                                   target="_blank"><?php echo $kb_pendidikan->bk_buktipenugasan ?></a></td>
                                            <td class="text-center"><?php echo $kb_pendidikan->bk_sks ?></td>
                                            <td><?php echo $kb_pendidikan->masa_penugasan ?></td>
                                            <td class="text-center"><?php echo $kb_pendidikan->kinerja_sks ?></td>
                                            <td><?php echo $kb_pendidikan->rekomendasi ?></td>
                                            <td><a href="files/kb_pendidikan/<?php echo $kb_pendidikan->kb_dokumen ?>"
                                                   target="_blank"><?php echo $kb_pendidikan->kb_dokumen ?></a></td>
                            ...
                            <form action="pages/simpan_kb_pendidikan.php" method="POST">
                                <input type="hidden" name="id_user" value="<?php echo $id_user ?>">
                                <div class="row clearfix">
                                    <br>
                                    <div class="">
                                    ...
                                    <div class="">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <label>Nomor KBP</label>
                                                    <input readonly type="text" class="form-control" name="nomor_kbp"
                                                           value="<?php echo count( $last_no_kbp ) > 0 ? $last_no_kbp[0]->id_kbp + 1 : 0 + 1 ?>">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <button type="submit" name="simpan_kbp_detil"
